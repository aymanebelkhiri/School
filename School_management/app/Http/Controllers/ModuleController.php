...
class ModuleController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($module->save()) {
            $messageSuccess = 'module mis à jour avec succès';
            return redirect()->route('modules.index')->with('messageSuccess', $messageSuccess);
        } else {
            $messageEchec = 'Échec de la mise à jour du module';
