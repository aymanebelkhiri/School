...
<script>
    ...
    form.addEventListener('submit', function(event) {
        ...
        document.getElementById('card-button').disabled = true; // Disable the button to prevent multiple submissions.
        ...
        stripe.createPaymentMethod({
            ...
            if (result.error) {
                ...
                document.getElementById('card-button').disabled = false; // Re-enable the button if there's an error.
            } else {
